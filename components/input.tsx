	...
	return (
		<div className="mb-3">
			...
			<input
				...
				ref={ref}
				className={
					"text-gray-600 dark:text-white rounded-lg p-2 border-2  dark:border-gray-500 w-full bg-gray-50 focus:outline-none dark:bg-gray-700 " + classoverride + `${errors[name] ? " focus:ring-red-500 focus:border-red-500" : "focus:ring-blue-500 focus:border-blue-500"}`
				}
			/>
			{errors[name] && (
